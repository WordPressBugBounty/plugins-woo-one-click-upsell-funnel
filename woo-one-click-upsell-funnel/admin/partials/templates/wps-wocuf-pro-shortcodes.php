				...
				<td class="forminp forminp-text">
					<div class="wps_upsell_shortcode_div">
						<p class="wps_upsell_shortcode">
							...
							<span class="wps_upsell_shortcode_content"><?php echo esc_html( '[wps_upsell_yes]' ); ?></span>
						</p>
					</div>
					<div class="wps_upsell_shortcode_div" >
						<p class="wps_upsell_shortcode">
							...
							<span class="wps_upsell_shortcode_content"><?php echo esc_html( '[wps_upsell_no]' ); ?></span>
						</p>
					</div>		
				</td>
			</tr>
				...
				<td class="forminp forminp-text">
					<div class="wps_upsell_shortcode_div">
						<p class="wps_upsell_shortcode">
							...
							<span class="wps_upsell_shortcode_content"><?php echo esc_html( '[wps_upsell_title]' ); ?></span>
						</p>
					</div>
					<div class="wps_upsell_shortcode_div" >
						<p class="wps_upsell_shortcode">
							...
							<span class="wps_upsell_shortcode_content"><?php echo esc_html( '[wps_upsell_desc]' ); ?></span>
						</p>
					</div>	
					<div class="wps_upsell_shortcode_div" >
						<p class="wps_upsell_shortcode">
							...
							<span class="wps_upsell_shortcode_content"><?php echo esc_html( '[wps_upsell_desc_short]' ); ?></span>
						</p>
					</div>
					<div class="wps_upsell_shortcode_div" >
						<p class="wps_upsell_shortcode">
							...
							<span class="wps_upsell_shortcode_content"><?php echo esc_html( '[wps_upsell_product_shipping_price]' ); ?></span>
						</p>
					</div>
					...
					<div class="wps_upsell_shortcode_div" >
						<p class="wps_upsell_shortcode">
							...
							<span class="wps_upsell_shortcode_content"><?php echo esc_html( '[wps_upsell_image]' ); ?></span>
						</p>
					</div>
					<div class="wps_upsell_shortcode_div" >
						<p class="wps_upsell_shortcode">
							...
							<span class="wps_upsell_shortcode_content"><?php echo esc_html( '[wps_upsell_price]' ); ?></span>
						</p>
					</div>
					<div class="wps_upsell_shortcode_div" >
						<p class="wps_upsell_shortcode">
							...
							<span class="wps_upsell_shortcode_content"><?php echo esc_html( '[wps_upsell_variations]' ); ?></span>
						</p>
					</div>
				</td>
			</tr>
				...
				<td class="forminp forminp-text">
					<div class="wps_upsell_shortcode_div">
						<p class="wps_upsell_shortcode">
							...
							<span class="wps_upsell_shortcode_content"><?php echo esc_html( '[wps_upsell_star_review]' ); ?></span>
						</p>
					</div>
					<div class="wps_upsell_shortcode_div">
						<p class="wps_upsell_shortcode">
							...
							<span class="wps_upsell_shortcode_content"><?php echo esc_html( '[wps_upsell_quantity]' ); ?></span>
						</p>
					</div>
					<div class="wps_upsell_shortcode_div">
						<p class="wps_upsell_shortcode">
							...
							<span class="wps_upsell_shortcode_content"><?php echo esc_html( '[wps_upsell_timer]' ); ?></span>
						</p>
					</div>
				</td>
			</tr>
